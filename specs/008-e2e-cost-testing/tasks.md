...
1. Use real Pulumi YAML projects in `test/e2e/fixtures/` with:
...
- [x] T003 [P] Create `test/e2e/fixtures/ec2/` with real Pulumi project (Pulumi.yaml, main.go, go.mod)
...
- [x] T011 [P] [US1] Create `test/e2e/fixtures/ec2/` with VPC, subnet, security group, and t3.micro EC2 instance
- [x] T012 [P] [US1] (Deferred) Create `test/e2e/fixtures/ebs/` with gp3 EBS volume
