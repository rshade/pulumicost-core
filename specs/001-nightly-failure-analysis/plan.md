...
**Branch**: `001-nightly-failure-analysis` | **Date**: 2025-12-16 | **Spec**: [specs/001-nightly-failure-analysis/spec.md](specs/001-nightly-failure-analysis/spec.md)
**Input**: Feature specification from `specs/001-nightly-failure-analysis/spec.md`
...
```text
specs/001-nightly-failure-analysis/
├── plan.md              # This file
