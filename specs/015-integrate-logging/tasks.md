...
**Input**: Design documents from `/specs/015-integrate-logging/`
...
- [x] T037 [P] Add logging configuration examples to quickstart in specs/015-integrate-logging/quickstart.md
