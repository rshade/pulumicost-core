...
- [x] T001 Create fixture directory `test/e2e/fixtures/analyzer`
- [x] T002 Create `test/e2e/fixtures/analyzer/Pulumi.yaml` with initial
...
- [x] T007 [US2] Update `test/e2e/fixtures/analyzer/Pulumi.yaml` to include a
