...
- [ ] **Project Rename**
  ...
  - *Current Leader*: **Tailly** (CLI: `tally`)
    ...
    - *Command*: `tally cost projected` (avoiding `tail` conflict,
  ...
  - *Decision*: Leaning towards **Tailly** for better DX, while acknowledging
    **FinFocus** has stronger enterprise signaling.
